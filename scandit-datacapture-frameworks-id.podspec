Pod::Spec.new do |s|
    ...
    s.source                  = { :git => 'https://github.com/Scandit/scandit-datacapture-frameworks-id.git', :tag => '8.1.4' }
    s.swift_version           = '5.7'
    ...
    s.dependency 'ScanditIdCapture', '= 8.1.4'
    s.dependency 'scandit-datacapture-frameworks-core', '= 8.1.4'
end
