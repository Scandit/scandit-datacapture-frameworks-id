Pod::Spec.new do |s|
    ...
    s.source                  = { :git => 'https://github.com/Scandit/scandit-datacapture-frameworks-id.git', :tag => '6.25.0' }
    s.swift_version           = '5.7'
    ...
    s.dependency 'ScanditIdCapture', '= 6.25.0'
    s.dependency 'scandit-datacapture-frameworks-core', '= 6.25.0'
end
