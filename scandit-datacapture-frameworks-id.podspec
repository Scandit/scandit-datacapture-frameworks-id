Pod::Spec.new do |s|
    ...
    s.source                  = { :git => 'https://github.com/Scandit/scandit-datacapture-frameworks-id.git', :tag => '7.5.1' }
    s.swift_version           = '5.7'
    ...
    s.dependency 'ScanditIdCapture', '= 7.5.1'
    s.dependency 'scandit-datacapture-frameworks-core', '= 7.5.1'
end
