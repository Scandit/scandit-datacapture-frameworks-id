...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/Scandit/scandit-datacapture-frameworks-core.git", exact: "8.4.0"),
        .package(url: "https://github.com/Scandit/datacapture-spm.git", exact: "8.4.0"),
    ],
    targets: [
