...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/Scandit/scandit-datacapture-frameworks-core.git", exact: "8.2.1"),
        .package(url: "https://github.com/Scandit/datacapture-spm.git", exact: "8.2.1"),
    ],
    targets: [
